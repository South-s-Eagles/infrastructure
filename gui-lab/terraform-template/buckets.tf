...
resource "aws_s3_bucket" "trusted" {
  bucket = "trusted-souths-eagle-gui"
...
resource "aws_s3_bucket" "client" {
  bucket = "client-souths-eagle-gui"
...
resource "aws_s3_bucket" "data_pipeline" {
  bucket = "pipeline-airflow-souths-eagle-gui"
...
resource "aws_s3_bucket" "infra_resources_storage" {
  bucket = "infra-resources-souths-eagle-gui"
